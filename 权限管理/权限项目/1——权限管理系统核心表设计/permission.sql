...
CREATE TABLE `sys_acl`  (
  ...
  `operate_ip` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '最后一个更新者的ip地址',
...
CREATE TABLE `sys_log`  (
  ...
  `type` int(11) NOT NULL DEFAULT 0 COMMENT '权限更新类型，1：部门；2：用户；3：权限模块；4：权限；5：角色；6：角色用户关系；7：权限角色关系',
  `target_id` int(11) NOT NULL COMMENT '基于type后指定的对象id，比如用户、权限、角色表的主键',
  `old_value` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '旧值',
  `new_value` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '新值',
  `operator` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '操作者',
  `operate_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后一次更新的时间',
  `operate_ip` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '最后一次更新者的IP地址',
...
CREATE TABLE `sys_user`  (
  ...
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '用户的状态，1：正常状态；0：冻结状态；2：删除',
  `remark` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '备注',
  `operator` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '操作者',
  `operate_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后一次更新时间',
  `operate_ip` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '最后一次更新的IP',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
